...
<main>
    ...
    <article class="margins">
        <section id="intro" class="margin-top section-hide">
        ...
        <section id="tabs" class="margin-top section-hide">
            <div class="container">
        ...
        <section id="gallery" class="margin-top section-hide">
            <div class="gallery">
                <?php
                $count = 0;
        ...
        <section id="section1" class="margin-top">
            <?php foreach ($sections as $section) :
                ...
                if (!($countSection % 2) == 0) :
            ?>
                    <div class="container section section-hide">
                        ...
                        <div class="content">
                            ...
                            <div class="content-text">
                                ...
                                <?php if(isset($section['boton']['url']) and isset($section['boton']['title'])) {?>
                                <div class="boton">
                                    <p><a href="<?php echo $section['boton']['url']; ?>"><?php echo $section['boton']['title']; ?></a></p>
                                </div>
                                <?php 
                                }; ?>
                            </div>
        ...
        <section id="section2" class="margin-top section-hide">
        ...
        ?>
        <section id="contact" class="section-hide">
